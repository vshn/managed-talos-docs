...
vale_cmd ?= $(engine_cmd) run $(engine_opts) --volume "$${PWD}"/docs/modules:/pages:Z ghcr.io/vshn/vale:3.13.0 --minAlertLevel=error --config=/pages/ROOT/pages/.vale.ini /pages
